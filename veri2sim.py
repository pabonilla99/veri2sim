...
cli.add_argument(
    ...
    type=str,
    nargs="?",
    help="Path to the Verilog file (required for the compile command)",
)
...
if args.command == "compile":
    ...
    component = Component(result.name, result.symbols, result.statements)
